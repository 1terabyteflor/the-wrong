...
export default async function Curatorship() {
    return (
        ...
        Using different raw materials as a source of inspiration the corpus gathers collage, digital and analogue photography, video, illustration and sounds.</p>
                ...
                <p className="font-arial text-sm">Laura Focarazzo is an experimental filmmaker and independent curator based in Buenos Aires, Argentina. She holds an MA in Curatorship of Visual Art, and researches in the field of Electronic Arts.  <br></br><br></br>
