    ...
    <div className='flex items-center min-h-screen h-screen w-full mx-0 text-center custom-img bg-fixed bg-center justify-center'>
        ...
        <Link className='scroll-smooth' href='#artists'>
          <div className='flex flex-col top-2/4 left-1/3  items-center'>
            ...
            <div className='rounded border-white z-[4] drop-shadow-xl items-center flex justify-center p-3 mt-4 border-[3px] glass animate-pulse '>
            <Image src="/Vector.svg" width={35} height={20} alt='action' className='  -rotate-90 md:rotate-0 '/>  
            </div>
          </div>
        </Link>
        <Logo/>
